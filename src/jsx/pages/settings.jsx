                                            ...
                                            <form action="#">
                                                <div className="row">
                                                    <div className="mb-3 col-xl-12">
                                                        ...
                                                        <input type="text" className="form-control f" placeholder="نام" />
                                                    </div>
                                                    <div className="mb-3 col-xl-12">
                                                        <div className="d-flex align-items-center mb-3">
                                                            ...
                                                            <div className="d-flex w-100">
                                                                <h4 className="mb-0">علی علی پور</h4>
                                                                <small className="mb-0 me-auto" style={{fontSize:0.7+'em'}}>حداکثر سایز مجاز برای فایل 20mb
                                                            </small>
                                                            </div>
                                                        </div>
                                            ...
                                            <form method="post" name="myform" className="personal_validate">
                                                <div className="row">
                                                    <div className="mb-3 col-xl-6">
                                                        <label className="form-label">نام و نام خانوادگی</label>
                                                        <input type="text" className="form-control f" placeholder="علی علیپور"
                                                            name="fullname" />
                                                    </div>
                                                    <div className="mb-3 col-xl-6">
                                                    ...
                                                    <div className="mb-3 col-xl-6">
                                                        ...
                                                        <input type="text" className="form-control" placeholder="1373/11/24"
                                                            id="datepicker" autocomplete="off" name="dob" />
                                                    </div>
                                                    <div className="mb-3 col-xl-6">
                                                        <label className="form-label">آدرس</label>
                                                        <input type="text" className="f form-control"
                                                            placeholder="تبریز ولیعصر" name="presentaddress" />
                                                    </div>
                                                    <div className="mb-3 col-xl-6">
                                                        <label className="form-label">آدرس کامل</label>
                                                        <input type="text" className="f form-control"
                                                            placeholder="ولیعصر کوی استانداری ... "
                                                            name="permanentaddress" />
                                                    </div>
                                                    <div className="mb-3 col-xl-6">
                                                        <label className="form-label">شهر</label>
                                                        <input type="text" className="f form-control" placeholder="تبریز"
                                                            name="city" />
                                                    </div>
                                                    <div className="mb-3 col-xl-6">
