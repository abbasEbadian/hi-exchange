                    ...
                    {currencyID !== Constants.IRT_CURRENCY_ID ?<>
                        <div className="col-12 mb-3">
                            ...
                            {/* <small>کارمزد برداشت: <span className="text-success">{ withdrawWallet.service && withdrawWallet.service.withdrawFee}</span> {" "}{withdrawWallet.service.name}</small>
                                ...
                                {withdrawWallet?<small>کارمزد برداشت: <span className="text-success">{ withdrawWallet.service && withdrawWallet.service.withdrawFee}</span> {" "}{withdrawWallet.service.name}</small>:undefined}
